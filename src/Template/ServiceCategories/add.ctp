<?php 
	...
	$this->assign('heading','Add Service Category');
	...
	<div class="row mbl">
		...
		<div class="col-lg-12">
			<div class="panel panel-grey">
				<div class="panel-heading">Add Service Category</div>
				<div class="panel-body">
					<div class="row">
						<div class="col-lg-12">
							<div class="panel-body pan">
								<?php echo $this->Form->create($serviceCategory,["name" => "add-form", "id" => "add-form", "method" => "POST", "type" => "file"]); ?>
										...
										<div class="col-md-12">
											<div class="form-group">
												...
												<div class="input-icon right">
													<?php echo $this->Form->control('category_name', ['autocomplete' => 'off', 'class' => 'form-control validate[required]', 'label'=>false, 'required'=>false, 'div'=>false]);?>
												</div>
											</div>
										</div>
										<div class="col-md-12">
