				...
				<div class="panel-heading">
					<div class="row">
						...
						<div class="col-lg-6" style="text-align: right;">
							<a href="<?=$this->Url->build(['controller'=>'BeverageItemOrders', 'action'=>'view', $beverageItemOrder->id]);?>" class="btn btn-success">Back to Beverage & Bar</a>
							<a href="<?=$this->Url->build(['controller'=>'BeverageItemOrders', 'action'=>'barbillprint', $beverageItemOrder->id]);?>" target="_blank" class="btn btn-yellow">Print</a>
						</div>
					</div>
				</div>
									...
									<div class="row">
										<div class="col-md-12">
											<div class="form-group">
												...
												<b>Bill No:</b> BOT-<?php echo date("Y") ?>-<?php echo $beverageItemOrder->id; ?> <br />
												<b>Bill Date:</b> <?php echo $this->Common->entry_date($beverageItemOrder->order_date);?> <br />
													...
													<div class="form-group col-md-12" style="padding-left:0px">
														<table width="100%" border="1">
															...
															<tr>
																<td>
																	<div class="input-icon right text-right" style="padding: 9px;">
																		<b>GST (<?php echo $site_general_settings->bar_gst_tax; ?>%)</b>
																	</div>
																</td>																
																<td>
																	<div class="input-icon right text-right" style="padding: 9px;">
