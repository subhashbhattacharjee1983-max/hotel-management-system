<?php 
	$this->assign('title','Recent Bar Orders (BOT)');
	$this->assign('heading','List of Recent Bar Orders (BOT)');
	$this->assign('breadcrumb','Recent Bar Orders (BOT)'); 
			...
			<div class="col-lg-12">
				 <div class="panel panel-grey">
					...
					<div class="panel-heading">
						<div class="row">
							<div class="col-lg-6">Recent Bar Orders (BOT)</div>
												...
												?>
													<tr>
														...
														<td class="actions">															
															...
															<?php } ?>
															<?php if($beverageItemOrder->is_payment == "U"){ ?>
															<a onclick="return confirm('Are you sure you want to delete?')" href="<?php echo $this->Url->build(['controller'=>'BeverageItemOrders', 'action'=>'delete',$beverageItemOrder->id]);?>"><?php echo $this->Html->image('/img/icons/delete.png', array('alt' => 'Delete', 'border' => '0',  ))?></a>
															<?php } ?>
														</td>
													</tr>
												<?php 
