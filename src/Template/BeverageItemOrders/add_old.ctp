...
<!--
	...
	function show_item_amount(item_val,val)
	{
		...
		$.ajax({		
			type:'POST',
			url:"<?=$this->Url->build(['controller'=>'BeverageItemOrders', 'action'=>'fetchItemAmount'])?>",
			data:{
				item_id:item_id[0]
			},
			headers : {
													...
													<div class="form-group col-md-12" style="padding-left:0px" id="wrap">
														<table width="100%" border="1">
															...
															<tr>
																...
																<td>
																	<div class="input-icon right">
																		<select style="width:100%; border:0;" name="beverage_item_name[]" id="beverage_item_name1" class="form-control validate[required]" onChange="show_item_amount(this.value, 1)" required>
...
$(".addmore").on('click',function(){
	...
	data +="<td><div class='input-icon right'><select style='width:100%;border:0;' name='beverage_item_name[]' id='beverage_item_name"+i+"' class='form-control validate[required]' onChange='show_item_amount(this.value, "+i+")' required><option value=''>Select Item</option></select></div></td>";
