...
<?php ob_start(); ?>				
	<div style="width: 100%; text-align: center;">
		...
		<div style="margin-bottom:15px; font-size:19px;">Food & Kitchen Report</div>
	</div>
	<div style="width: 100%;">
	<table border="1" style="width: 100%;" cellpadding="0" cellspacing="0">
		<thead>
			<tr>
				...
				<th>Mobile Number</th>
				<th>Food Charge</th>
				<th>Service Charge (<?php echo $site_general_settings->food_service_tax; ?>%)</th>
				<th>BST Charge (<?php echo $site_general_settings->food_bst_tax; ?>%)</th>
				<th>GST Charge (<?php echo $site_general_settings->food_gst_tax; ?>%)</th>
				<th>Grand Total</th>
			</tr>
		</thead>
		<tbody>
