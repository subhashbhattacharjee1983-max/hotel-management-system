<?php 
	$this->assign('title','Outstanding Report');
	$this->assign('heading','List of Outstanding Report');
	$this->assign('breadcrumb','Outstanding Report'); 
			...
			<div class="col-lg-12">
				 <div class="panel panel-grey">
					...
					<div class="panel-heading">
						<div class="row">
							<div class="col-lg-6">Outstanding Report From <?php echo $start_date_outstanding ?> to <?php echo $end_date_outstanding ?></div>
							<div class="col-lg-6" style="text-align: right;">
								<a href="<?php echo $this->Url->build(['controller'=>'Bookings', 'action'=>'outstandingcsv', $start_date_outstanding, $end_date_outstanding]);?>" target="_blank" class="btn btn-success">Export CSV</a>
								<a href="<?php echo $this->Url->build(['controller'=>'Bookings', 'action'=>'outstandingpdf', $start_date_outstanding, $end_date_outstanding]);?>" target="_blank" class="btn btn-orange-middle">View PDF</a>
							</div>
						</div>
					</div>
								...
								<div class="panel-body pan">
									<div class="form-body pal">
											<table cellpadding="0" cellspacing="0" class="table table-hover">
												...
												?>
													<tr>
														<td><?php echo h($booking->id); ?> <a href="<?=$this->Url->build(['controller'=>'Bookings', 'action'=>'view', $booking->id]);?>"><?=$this->Html->image('/img/icons/view.png', array('alt' => 'View Booking Details', 'border' => '0', 'title' => 'View Booking Details'))?></a> <a href="<?=$this->Url->build(['controller'=>'BookingPayments', 'action'=>'index',$booking->id]);?>"><?=$this->Html->image('/img/icons/payment.png', array('alt' => 'Payment', 'border' => '0', 'title' => 'Payment'))?></a></td>														
														...
														<td style="color: <?php echo ($booking->booking_verified == "All Verified" ? 'green' : 'red'); ?>"><?php echo $booking->booking_verified; ?></td>	
													</tr>
												<?php 
													}
													endforeach;
