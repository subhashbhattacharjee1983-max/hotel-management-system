<?php 
	$this->assign('title','Unpaid Bookings');
	$this->assign('heading','List of Unpaid Bookings');
	$this->assign('breadcrumb','Unpaid Bookings'); 
			...
			<div class="col-lg-12">
				 <div class="panel panel-grey">
					...
					<div class="panel-heading">
						<div class="row">
							<div class="col-lg-6">Unpaid Bookings</div>
