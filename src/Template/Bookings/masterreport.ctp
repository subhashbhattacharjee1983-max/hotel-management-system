<?php 
	$this->assign('title','Master Report');
	$this->assign('heading','List of Master Report');
	$this->assign('breadcrumb','Master Report'); 
			...
			<div class="col-lg-12">
				 <div class="panel panel-grey">
					<div class="panel-heading">
						<div class="row">
							<div class="col-lg-6">Master Report From <?php echo $start_date_master ?> to <?php echo $end_date_master ?></div>
							<div class="col-lg-6" style="text-align: right;">
								<a href="<?php echo $this->Url->build(['controller'=>'Bookings', 'action'=>'masterbillcsv', $start_date_master, $end_date_master]);?>" target="_blank" class="btn btn-success">Export CSV</a>
								<a href="<?php echo $this->Url->build(['controller'=>'Bookings', 'action'=>'masterbillpdf', $start_date_master, $end_date_master]);?>" target="_blank" class="btn btn-orange-middle">View PDF</a>
							</div>
						</div>
					</div>
