<?php 
	$this->assign('title','Recent Bookings');
	$this->assign('heading','List of Recent Bookings');
	$this->assign('breadcrumb','Recent Bookings'); 
			...
			<div class="col-lg-12">
				 <div class="panel panel-grey">
					...
					<div class="panel-heading">
						<div class="row">
							<div class="col-lg-6">Recent Bookings</div>
											...
											<table cellpadding="0" cellspacing="0" class="table table-hover" id="myTable">
												...
												?>
													<tr>
														...
														<td><a style="width: 85px;" class="status_btn status_checks <?=$booking->booking_status=='C' ? "btn-success" : "btn-info";?>"><?php echo h($booking_status[$booking->booking_status]); ?></a></td>
														...
														<td class="actions">															
															...
															if($booking->booking_status!="O")
															{
																...
																{ 
															?>
															<a href="<?=$this->Url->build(['controller'=>'FoodItemOrders', 'action'=>'add', $booking->id]);?>"><?=$this->Html->image('/img/icons/food.png', array('alt' => 'Food Order', 'border' => '0', 'title' => 'Food Order'))?></a>&nbsp;
															<a href="<?=$this->Url->build(['controller'=>'BeverageItemOrders', 'action'=>'add',$booking->id]);?>"><?=$this->Html->image('/img/icons/drinks.png', array('alt' => 'Drinks Order', 'border' => '0', 'title' => 'Drinks Order'))?></a>&nbsp;															
															...
															<a href="<?=$this->Url->build(['controller'=>'HousekeepingOrders', 'action'=>'index',$booking->id]);?>"><?=$this->Html->image('/img/icons/room_service.png', array('alt' => 'Room Service', 'border' => '0', 'title' => 'Room Service'))?></a>&nbsp;
															<a href="<?=$this->Url->build(['controller'=>'Bookings', 'action'=>'edit', $booking->id]);?>"><?=$this->Html->image('/img/icons/edit.png', array('alt' => 'Edit Booking', 'border' => '0', 'title' => 'Edit Booking'))?></a>&nbsp;
															<?php
																	if($booking->payment_status == "U")
																	{
															?>
															<a onclick="return confirm('Are you sure you want to delete this booking?')" href="<?php echo $this->Url->build(['controller'=>'Bookings', 'action'=>'delete', base64_encode($booking->id)]);?>"><?php echo $this->Html->image('/img/icons/delete.png', array('alt' => 'Delete Booking', 'border' => '0',  ))?></a>
															<?php
																	}
																}
															} 
