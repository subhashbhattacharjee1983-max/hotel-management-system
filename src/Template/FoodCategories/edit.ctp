<?php 
	...
	$this->assign('heading','Edit Food Category');
	...
	<div class="row mbl">
		...
		<div class="col-lg-12">
			<div class="panel panel-grey">
				<div class="panel-heading">Edit Food Category</div>
				<div class="panel-body">
					<div class="row">
						<div class="col-lg-12">
							<div class="panel-body pan">
								<?php echo $this->Form->create($foodCategory,["name" => "edit-form", "id" => "edit-form", "method" => "POST", "type" => "file"]); ?>
