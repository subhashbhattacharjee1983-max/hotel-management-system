	<?php 
	$this->assign('title','Update Kitchen Order (KOT)');
	$this->assign('heading','Update Kitchen Order (KOT)');
	$this->assign('breadcrumb','Update Kitchen Order (KOT)'); 
	...
	<div class="row mbl">
		...
		<div class="col-lg-4">
			<div class="panel panel-grey">
				<div class="panel-heading">Kitchen Order <?php echo $foodItemOrder['booking_id']!=0 ? 'for Booking Id: '.$foodItemOrder['booking_id'] : '' ?></div>
										...
										<div class="col-md-12">
											<div class="form-group">
												...
												<div class="input-icon right">
													<?php //pr($foodItemOrder);
													if($foodItemOrder['booking_id'] > 0)
													{
														echo $order_type[$foodItemOrder->order_type];
													}
													else
													{
														echo $order_type[$foodItemOrder->order_type];
										...
										<div id="show_table">
											...
											<div class="col-md-6">
												<div class="form-group">
													...
													<div class="input-icon right">
														<?php echo $this->Form->control('from_date', ['autocomplete' => 'off', 'placeholder' => 'From Date', 'type' => 'text', 'class' => 'form-control datepicker', 'data-errormessage-value-missing'=>'From Date is required', 'label'=>false, 'required'=>false, 'div'=>false, 'value' => date("Y-m-d",strtotime($foodItemOrder->from_date))]);?>
													</div>
												</div>
											</div>
											<div class="col-md-6">
												<div class="form-group">
													...
													<div class="input-icon right">
														<?php echo $this->Form->control('to_date', ['autocomplete' => 'off', 'placeholder' => 'To Date', 'type' => 'text', 'class' => 'form-control datepicker', 'data-errormessage-value-missing'=>'To Date is required', 'label'=>false, 'required'=>false, 'div'=>false, 'value' => date("Y-m-d",strtotime($foodItemOrder->to_date))]);?>
													</div>
												</div>
											</div>
											<div class="col-md-12">
													...
													<div class="form-group col-md-12" style="padding:0px" id="wrap">
														<table width="100%" border="1">
															...
															<tr>
																...
																<td>
																	<div class="input-icon right text-center">
																		<input name="edit_item_price[]" id="item_price<?php echo $key_dtls ?>" placeholder="" class="form-control validate[required] ramt" value="<?php echo round($val->price); ?>" type="text" onKeyUp="tot_bill_amt(1)" style="border:0; background:#FFFFFF; text-align: center;" autocomplete="off" onKeyPress="return is_amount(event, this)" readonly>
																	</div>
																</td>
																<td>
																	<div class="input-icon right text-center">
																		<input name="edit_item_quantity[]" id="item_quantity<?php echo $key_dtls ?>" placeholder="" class="form-control validate[required] damt" value="<?php echo $val->quantity; ?>" type="text" onKeyUp="tot_bill_amt(1)" style="border:0; background:#FFFFFF; text-align: center;" autocomplete="off" onKeyPress="return number(event, this)" oninput="checkNumberFieldLength(this)" readonly>
																	</div>
																</td>
																<td>
																	<div class="input-icon right text-center">
																		<input name="edit_item_no_of_days[]" id="item_no_of_days<?php echo $key_dtls ?>" placeholder="" class="form-control validate[required] item_no" value="<?php echo $val->item_no_of_days; ?>" type="text" onKeyUp="tot_bill_amt(1)" style="border:0; background:#FFFFFF;" autocomplete="off" onKeyPress="return number(event, this)" oninput="checkNumberFieldLength(this)" readonly>
																	</div>
																</td>
																<td>
																	<div class="input-icon right text-center">
																		<input name="edit_item_sub_total[]" id="item_sub_total<?php echo $key_dtls ?>" placeholder="" class="form-control validate[required] bamt" value="<?php echo round($val->sub_total); ?>" type="text" style="border:0; background:#FFFFFF; text-align: center;" autocomplete="off" onKeyPress="return is_amount(event, this)" readonly>
																	</div>
																</td>
															</tr>
															<?php
															...
															$total_item = count($foodItemOrder->food_item_details) + 1;
															?>
															<tr>
																<td><!-- &nbsp;<input type='checkbox' class='case'/>&nbsp; --></td>
																<td>
																	<div class="input-icon right">
																		<select style="width:270px; border:0;" name="food_item_name[]" id="food_item_name<?php echo $total_item ?>" class="chosen form-control validate[required]" onChange="show_item_amount(this.value, <?php echo $total_item ?>)" required>
																...
																<td>
																	<div class="input-icon right">
																		<input name="item_price[]" id="item_price<?php echo $total_item ?>" placeholder="" class="form-control validate[required] ramt" value="0" type="text" onKeyUp="tot_bill_amt(<?php echo $total_item ?>)" style="border:0; background:#FFFFFF;" autocomplete="off" onKeyPress="return is_amount(event, this)">
																	</div>
																</td>
																<td>
																	<div class="input-icon right">
																		<input name="item_quantity[]" id="item_quantity<?php echo $total_item ?>" placeholder="" class="form-control validate[required] damt" value="0" type="text" onKeyUp="tot_bill_amt(<?php echo $total_item ?>)" style="border:0; background:#FFFFFF;" autocomplete="off" onKeyPress="return number(event, this)" oninput="checkNumberFieldLength(this)">
																	</div>
																</td>
																<td>
																	<div class="input-icon right">
																		<input name="item_no_of_days[]" id="item_no_of_days<?php echo $total_item ?>" placeholder="" class="form-control validate[required] item_no" value="0" type="text" onKeyUp="tot_bill_amt(<?php echo $total_item ?>)" style="border:0; background:#FFFFFF;" autocomplete="off" onKeyPress="return number(event, this)" oninput="checkNumberFieldLength(this)">
																	</div>
																</td>
																<td>
																	<div class="input-icon right">
																		<input name="item_sub_total[]" id="item_sub_total<?php echo $total_item ?>" placeholder="" class="form-control validate[required] bamt" value="0" type="text" style="border:0; background:#FFFFFF;" autocomplete="off" onKeyPress="return is_amount(event, this)" readonly>
																	</div>
																</td>
																<input type="hidden" name="slider_count" id="slider_count" value="<?php echo $total_item ?>">
															</tr>
														</table>
													</div>
				...
				<div class="row">
					<div class="col-md-12">
						<div class="text-right" style="padding-top: 7%;">
							<?=$this->Form->button('Update Order', ['type'=>'button', 'name'=>'btn_submit', 'id'=>'btn_submit', 'style' => 'width: 100%; padding: 9px;', 'class'=>'btn btn-booking', 'value'=>'Submit', 'onclick' => 'YourOnSubmitFn()']);?>
						</div>
					</div>
				</div>
			</div>
