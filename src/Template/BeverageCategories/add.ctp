<?php 
	...
	$this->assign('heading','Add Beverage Category');
	...
	<div class="row mbl">
		...
		<div class="col-lg-12">
			<div class="panel panel-grey">
				<div class="panel-heading">Add Beverage Category</div>
				<div class="panel-body">
					<div class="row">
						<div class="col-lg-12">
							<div class="panel-body pan">
								<?php echo $this->Form->create($beverageCategory,["name" => "add-form", "id" => "add-form", "method" => "POST", "type" => "file"]); ?>
